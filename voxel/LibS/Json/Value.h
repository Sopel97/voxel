...
#include "../Memory/HomogeneousMemoryPool.h"
...
namespace ls
{
    namespace json
    {
        class Value
        {
            ...
            static constexpr bool useStaticEmbeddedHomogeneousMemoryPool = false;

        public:
            using Array = std::vector<Value>;
            using Object = typename std::conditional<useUnorderedMap, std::unordered_map<std::string, Value>, std::map<std::string, Value, std::less<>>>::type;
            ...
            {
                if (!exists()) attemptToModifyInexistingValue();
        ...
        private:
            struct EmptyStruct {};
            class ValueUnion : public std::conditional<useStaticEmbeddedHomogeneousMemoryPool, mem::StaticEmbeddedHomogeneousMemoryPool<ValueUnion>, EmptyStruct>::type
            {
            public:
            ...
            [[noreturn]] void attemptToModifyInexistingValue() const
            {
